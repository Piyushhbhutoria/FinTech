...
<html>
	...
	<body>
		...
		?>
		<font size="-1" color="#000000">This <b>mortgage calculator</b> can be used to figure out monthly payments of a home
			mortgage loan,
			based on the home's sale price, the term of the loan desired, buyer's down payment percentage, and the loan's
			interest rate.
			This calculator factors in PMI (Private Mortgage Insurance) for loans where less than 20% is put as a down
			payment. Also taken
		...
		<form method="GET" name="information" action="<?php echo $_SERVER['PHP_SELF']; ?>">
			...
			<table cellpadding="2" cellspacing="0" border="0" width="100%">
				...
				<tr valign="top" bgcolor="#eeeeee">
					...
					<td width="100%"><input type="text" size="10" name="sale_price" value="<?php echo $sale_price; ?>">(In
						Dollars)</td>
				</tr>
				<tr valign="top" bgcolor="#eeeeee">
				...
				<tr valign="top" bgcolor="#eeeeee">
					...
					<td><input type="text" size="5" name="annual_interest_percent"
							value="<?php echo $annual_interest_percent; ?>">%</td>
				</tr>
				<tr valign="top" bgcolor="#eeeeee">
				...
				if ($form_complete && $monthly_payment) {
					...
					<tr valign="top" bgcolor="#eeeeee">
						...
						<td><b>
								<?php echo "\$" . number_format($down_payment, "2", ".", ","); ?>
							</b></td>
					</tr>
					<tr valign="top" bgcolor="#eeeeee">
						<td align="right">Amount Financed:</td>
						<td><b>
								<?php echo "\$" . number_format($financing_price, "2", ".", ","); ?>
							</b></td>
					</tr>
					<tr valign="top" bgcolor="#cccccc">
					...
					if ($down_percent < 20) {
						...
						<tr valign="top" bgcolor="#FFFFCC">
							...
							<td>
								...
								which tends
								to be about $55 per month for every $100,000 financed (until you have paid off 20% of your loan). This could
								add
						...
						<tr valign="top" bgcolor="#FFFF99">
							<td align="right">Monthly Payment:</td>
							<td><b>
									<?php echo "\$" . number_format(($monthly_payment + $pmi_per_month), "2", ".", ","); ?>
								</b><br>
								<font>
					...
					<tr valign="top" bgcolor="#CCCCFF">
						...
						<td>
							...
							?>
							Residential (or Property) Taxes are a little harder to figure out... In Massachusetts, the average
							resedential tax rate seems
							...
							<?php echo "\$" . number_format($assessed_price, "2", ".", ","); ?>. This would mean that your yearly
							residential taxes will be around
							<?php echo "\$" . number_format($residential_yearly_tax, "2", ".", ","); ?>
							This could add
							<?php echo "\$" . number_format($residential_monthly_tax, "2", ".", ","); ?> to your monthly payment.
						</td>
					</tr>
					<tr valign="top" bgcolor="#9999FF">
						<td align="right">TOTAL Monthly Payment:</td>
						<td><b>
								<?php echo "\$" . number_format(($monthly_payment + $pmi_per_month + $residential_monthly_tax), "2", ".", ","); ?>
							</b><br>
							<font>
								(including
								<?php echo $pmi_text; ?> residential tax)
							</font>
						</td>
					</tr>
					<?php
			...
			<table cellpadding="5" cellspacing="0" border="1" width="100%">
				<tr valign="top">
					...
					<td>
						...
						= The price of the home multiplied by the percentage down divided by 100 (for 5% down becomes 5/100 or
						0.05)<br><br>
						$
						<?php echo number_format($down_payment, "2", ".", ","); ?> = $
						<?php echo number_format($sale_price, "2", ".", ","); ?> X
						(
				...
				<tr valign="top">
					...
					<td>
						...
						<?php echo $annual_interest_rate; ?> =
						<?php echo $annual_interest_percent; ?>% / 100
					</td>
				</tr>
				<tr valign="top" bgcolor="#cccccc">
					<td colspan="2">
				...
				<tr valign="top">
					...
					<td>
						...
						year)<br><br>
						<?php echo $monthly_interest_rate; ?> =
				...
				<tr valign="top">
					...
					<td>
						The <b>month term</b> of the loan in months = The number of years you've taken the loan out for times
						12<br><br>
						<?php echo $month_term; ?> Months =
						<?php echo $year_term; ?> Years X 12
					</td>
				</tr>
				<tr valign="top">
					<td><b>
					...
					<td>
						...
						<br><br>
						The <a href="#amortization">amortization</a> breaks down how much of your monthly payment goes towards the
						bank's interest,
